...
<div id="page" class="container">
    ...
    <div id="main">
        ...
        <div class="info">
            ...
            <form action="/student/upload_studentImg" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<%=student.getId()%>">
                <input type="file" name="img">
                <input type="submit" value="上传头像">
            </form>

            <form action="/student/update_student_email" method="post">
...
<div id="password-dialog" title="修改安全信息">
    <form id="password-form" method="post">
        ...
        <input style="float: right; margin-right: 25px" type="submit" value="保存"
               onclick="this.form.action='/student/update_student_security'">
    </form>
</div>
