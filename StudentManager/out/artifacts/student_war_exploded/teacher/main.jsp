    ...
    <div id="header">
        ...
        <div id="menu">
            <ul>
                ...
                <li class="current_page_item"><a href="/student/one_page_student">学生管理</a></li>
                <li><a href="/student/one_page_score">成绩管理</a></li>
                <li><a onclick="return confirm('确认退出?');" href="/student/exit">退出登录</a></li>
            </ul>
        </div>
    </div>
    <div id="main">
        <div class="top">
            ...
            <div class="find">
                <form action="/student/one_page_student" method="post">
        ...
        <div class="table">
            <table id="table" width="800" frame="box" align="center">
                ...
                %>
                        <tr>
                            <form method="post" action="/student/update_student">
                                ...
                                <td><input type="submit" class="update-btn" value="修改">&nbsp;<a class="btn-delete"
                                                                                           ...
                                                                                           href=<%="'/student/delete_student?id=" + stu.getId() + "'"%>>删除</a>&nbsp;&nbsp;<a href="/student/one_page_score?id=<%=stu.getId()%>">查看成绩</a>
                                </td>
                            </form>
                        </tr>
                <%
        ...
        %>
                <div id="index">
                    <a href="/student/one_page_student?index=1">首页</a>
                    <%
                        for (int i=1; i<=sumIndex; i++){
                    %>
                            <a href="/student/one_page_student?index=<%=i%>">第<%=i%>页</a>
                    <%
                        }
                    %>
                    <a href="/student/one_page_student?index=<%=sumIndex%>">尾页</a>
                </div>
        <%
            }
        %>
...
<div id="add-dialog" title="添加学生信息">
    <form id="add-form" method="post">
        ...
        <input style="float: right; margin-right: 25px" type="submit" value="确定"
               onclick="this.form.action='/student/add_student'">
    </form>
</div>
