...
<div id="page" class="container">
    <div id="header">
        ...
        <div id="menu">
            <ul>
                ...
                <li><a href="/student/one_page_student">学生管理</a></li>
                <li class="current_page_item"><a href="/student/one_page_score">成绩管理</a></li>
    ...
    <div id="main">
        ...
        <form method="post" action="/student/update_score" style="height: 525px; margin-top: 20px">
        ...
        %>
                <div id="index">
                    <a href="/student/one_page_score?index=1">首页</a>
                    <%
                        for (int i = 1; i <= sumIndex; i++) {
                    %>
                    <a href="/student/one_page_score?index=<%=i%>">第<%=i%>页</a>
                    <%
                        }
                    %>
                    <a href="/student/one_page_score?index=<%=sumIndex%>">尾页</a>
                </div>
        <%
            }
        %>
